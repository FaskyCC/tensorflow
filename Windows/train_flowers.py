...
checkpoint_file = '/Users/Fa/Desktop/kaggle/inception_resnet_v2_2016_08_30.ckpt'
...
labels_file = '/Users/Fa/Desktop/Test/labels.txt'
...
def get_split(split_name, dataset_dir, file_pattern=file_pattern, file_pattern_for_counting='flowers'):
    ...
    keys_to_features = {
      ...
      'image/format': tf.FixedLenFeature((), tf.string, default_value=b'jpg'),
